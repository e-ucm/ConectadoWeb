...
export default class ChatScreen extends BaseScreen {
    ...
    createTextBox() {
        ...
        this.textBox.on('pointerdown', () => {
            xapiTracker.gameObjectTracker.Interacted("chatBoxScreen", JSTracker.GAMEOBJECTTYPE.ITEM);
    ...
    createReturnButton() {
        ...
        this.returnButton.on('pointerdown', () => {
            xapiTracker.gameObjectTracker.Interacted("returnButton", JSTracker.GAMEOBJECTTYPE.ITEM);
            if (!this.scene.dialogManager.isTalking()) {
