...
export default class CorridorBase extends BaseScene {
    ...
    create(params) {
        ...
        super.toggleDoor(boysRestroomdoorClosed, boysRestroomDoorOpened, () => {
            gameObjectXapiTracker.sendStatement(gameObjectXapiTracker.Interacted("boysRestroom", GAMEOBJECTTYPE.ITEM));
        ...
        super.toggleDoor(girlsRestroomDoorClosed, girlsRestroomDoorOpened, () => {
            gameObjectXapiTracker.sendStatement(gameObjectXapiTracker.Interacted("girlsRestroom", GAMEOBJECTTYPE.ITEM));
        ...
        super.toggleDoor(classDoorClosed, classDoorOpened, () => {
            gameObjectXapiTracker.sendStatement(gameObjectXapiTracker.Interacted("classDoorOpened", GAMEOBJECTTYPE.ITEM));
            if (this.classNode) {
