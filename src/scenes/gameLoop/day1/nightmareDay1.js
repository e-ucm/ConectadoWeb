...
export default class NightmareDay1 extends NightmareMinigame {
    ...
    activateChairForMinigame(chair, node) {
        ...
        chair.once('pointerover', () => {
            ...
            if (node) {
                xapiTracker.gameObjectTracker.Interacted("chair_with_dialog", JSTracker.GAMEOBJECTTYPE.ITEM);
                this.lastTouchedChair = chair;
                this.dialogManager.setNode(node);
            } else {
                xapiTracker.gameObjectTracker.Interacted("chair_without_dialog", JSTracker.GAMEOBJECTTYPE.ITEM);
