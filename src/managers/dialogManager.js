...
export default class DialogManager {
        ...
        if (this.currNode) {
            ...
            if (this.currNode.type === "condition") {
                ...
                if(!this.launched) {
                    ...
                    xapiTracker.completableTracker.Initialized(`${dialog.name} ${dialog.text}`, JSTracker.COMPLETABLETYPE.STORYNODE);
                    this.launched=true;
                }
                ...
                let fnAux = () => {
                    xapiTracker.alternativeTracker.Selected(this.currNode.postName, this.currNode.text, JSTracker.ALTERNATIVETYPE.DIALOG);
        ...
        if (this.currNode.type === "text") {
            ...
            // Si ha acabado de mostrarse todo el dialogo
                ...
                // Si ya se han mostrado todos los dialogos
                    ...
                    xapiTracker.completableTracker.Completed(`${dialog.name} ${dialog.text}`, JSTracker.COMPLETABLETYPE.STORYNODE,true, true);
                    this.launched=false;
    ...
    */
    selectOption(index) {
        ...
        xapiTracker.alternativeTracker.Selected(this.currNode.fullId, this.currNode.choices[index].text, JSTracker.ALTERNATIVETYPE.DIALOG);
