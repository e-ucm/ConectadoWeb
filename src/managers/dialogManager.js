...
export default class DialogManager {
    ...
    */
    changeScene(scene) {
        xapiTracker.accessible(scene.scene.key, xapiTracker.ACCESSIBLETYPE.SCREEN).Accessed();
        ...
        if (this.currNode) {
            ...
            if (this.currNode.type === "condition") {
                ...
                if(!this.launched) {
                    ...
                    xapiTracker.completable(`${dialog.name} ${dialog.text}`, xapiTracker.COMPLETABLETYPE.STORYNODE).Initialized();
                    this.launched=true;
                }
                ...
                let fnAux = () => {
                    xapiTracker.alternative(this.currNode.postName, xapiTracker.ALTERNATIVETYPE.DIALOG).Selected(this.currNode.text);
        ...
        if (this.currNode.type === "text") {
            ...
            // Si ha acabado de mostrarse todo el dialogo
                ...
                // Si ya se han mostrado todos los dialogos
                    ...
                    var dialog = this.currNode.dialogs[0];
                    xapiTracker.completable(`${dialog.name} ${dialog.text}`, xapiTracker.COMPLETABLETYPE.STORYNODE).Completed(true, true);
                    this.launched=false;
    ...
    */
    selectOption(index) {
        ...
        xapiTracker.alternative(this.currNode.fullId, xapiTracker.ALTERNATIVETYPE.DIALOG).Selected(this.currNode.choices[index].text);
